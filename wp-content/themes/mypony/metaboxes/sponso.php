...
class SponsoMetaBox{
    ...
    const META_KEY = 'mypony_sponso';
    const NONCE = '_mypony_sponso_nonce';
    ...
    public static function add($post_type, $post){
        if($post_type === 'post' && current_user_can('publish_posts', $post)){
    ...
    public static function render($post){
        ...
        <label for="myponysponso">Cet article est sponsorisé</label>
        <?php
    }
